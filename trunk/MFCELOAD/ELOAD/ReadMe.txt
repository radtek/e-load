...
ELOAD.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CELOADApp 응용 프로그램
    클래스를 선언합니다.

ELOAD.cpp
    응용 프로그램 클래스 CELOADApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Toolbar.bmp
    ...
    ELOAD.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
ELOADDoc.h, ELOADDoc.cpp - 문서
    이 파일에는 CELOADDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CELOADDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

ELOADView.h, ELOADView.cpp - 문서 뷰
    이 파일에는 CELOADView 클래스가 들어 있습니다.
    CELOADView 개체는 CELOADDoc 개체를 보는 데 사용됩니다.

res\ELOADDoc.ico
    CELOADDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다.  이 아이콘은 주 리소스 파일인 ELOAD.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 ELOAD.pch와
